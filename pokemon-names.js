...
// Every Pokémon's English name, numbers 1 to 1025, from PokéAPI (pokeapi.co), September 2026.
// The reader checks what it read against this list, so a misread "Pikachy" becomes "Pikachu".
// When new Pokémon come out, add their names at the end.
...
const POKEMON_NAMES = [
	...
	"Moltres", "Dratini", "Dragonair", "Dragonite", "Mewtwo", "Mew", "Chikorita", "Bayleef",
	...
	"Vanilluxe", "Deerling", "Sawsbuck", "Emolga", "Karrablast", "Escavalier", "Foongus",
	...
	"Fletchinder", "Talonflame", "Scatterbug", "Spewpa", "Vivillon", "Litleo", "Pyroar", "Flabébé",
	...
	"Skwovet", "Greedent", "Rookidee", "Corvisquire", "Corviknight", "Blipbug", "Dottler",
	...
	"Ting-Lu", "Chi-Yu", "Roaring Moon", "Iron Valiant", "Koraidon", "Miraidon", "Walking Wake",
	"Iron Leaves", "Dipplin", "Poltchageist", "Sinistcha", "Okidogi", "Munkidori", "Fezandipiti",
